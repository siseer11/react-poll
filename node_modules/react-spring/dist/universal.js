...
function callProp(obj, state, arg) {
...
function (_React$PureComponent) {
  ...
  Transition.getDerivedStateFromProps = function getDerivedStateFromProps(props, _ref2) {
    ...
    removed.forEach(function (key) {
      ...
      deleted.push(_extends({
        ...
        delay: trail = trail + delay,
        to: _extends({}, current[key].to, callProp(leave, _items ? _items[keyIndex] : key))
      }));
      delete current[key];
    });
  ...
  _proto.render = function render() {
    ...
    var _this$props2 = this.props,
        ...
        _this$props2$native = _this$props2.native,
        native = _this$props2$native === void 0 ? false : _this$props2$native,
        ...
        extra = _objectWithoutPropertiesLoose(_this$props2, ["render", "initial", "from", "enter", "leave", "native", "onDestroyed", "keys", "items", "onFrame", "onRest", "delay"]);
    ...
    return this.state.transitions.map(function (transition, i) {
      var key = transition.key,
          ...
          rest = _objectWithoutPropertiesLoose(transition, ["key", "item", "children", "from", "delay"]);
      ...
      return React.createElement(Spring, _extends({
        ...
        key: key,
        onRest: rest.destroyed ? _this2.destroyItem(item, key) : onRest && function (values) {
